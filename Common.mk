...
# "-Wl,--entry=main" is needed to tell LD that the entry point is the main
# function. Looks like the default is some other symbol..
#
...
LDFLAGS		= -Wl,--gc-sections -Wl,-s -Wl,--entry=main
INCLUDES	+= -I./ -Igcc/
### Build tools
# 
CC		= msp430-gcc
